...
public class AllinOne {
	...
	public void psiTest() throws Exception {
		...
		action.moveToElement(driver.findElement(
				By.xpath("//a[contains(@class,'layout-text_only')]" + "//following::span[contains(text(),'Markets')]")))
				.build().perform();
		Thread.sleep(3000);
		...
		actn.moveToElement(driver
				.findElement(By.xpath("//a[contains(@class,'')]" + "//following::span[contains(text(),'Company')][2]")))
				.build().perform();
		Thread.sleep(3000);
